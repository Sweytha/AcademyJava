...
public class TwoSum {
    // Method that returns the indices of two elements in the nums array that add up to the target value
    public int[] twoSum(int[] nums, int target) {
        ...
        for (int i = 0; i < nums.length; i++) {
            ...
            if (map.containsKey(complement)) {
                ...
                // because these two indices correspond to two elements that add up to the target
    ...
    public static void main(String[] args) {
        ...
        // Call the twoSum method to get the indices of the two elements that add up to the target value
